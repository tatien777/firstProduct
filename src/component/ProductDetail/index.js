                          ...
                          <p> {selectItem.description}</p> 
                                ...
                                exercitation.</p>
                                                ...
                                                <div className="review-box mt-50">
                                                    ...
                                                    <form className="review-form" action="_blank">
                                                        <div className="row">
                                                            <div className="col-xl-12">
                                ...
                                <div className="product-wrapper">
                                    <div className="product-img mb-25">
                                        ...
                                        <div className="product-action text-center">
                                            ...
                                            <a href="_blank" data-toggle="tooltip" data-placement="right" title="Compare">
                                    ...
                                    <div className="product-content">
                                        ...
                                        <div className="product-wishlist">
                                            <a href="_blank"><i className="far fa-heart" title="Wishlist" /></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
